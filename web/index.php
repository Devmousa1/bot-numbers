...
$chall = "numbers505";
$useradmin = "M_o_u_s0";
$sim = -1002320730911; #القناة الرسمية
$PAY = -1002365407730; #الارقام المكتملة
$ess = -1002254828742; #عمليات شراء الارقام
$eer = -1002393552612; #اشعارات الايميلات وتحويل الروبل
if ($chat_id == 7297709050) {
    $sudo = $chat_id;
} elseif ($chat_id == 7297709050) {
    $sudo = $chat_id;
} else {
    $sudo == 7297709050;
}
...
*- في بوت الإمبراطور* ؛ البوت الأفضل على التليجرام والذي يقوم بتوفير *خدمات الأرقام الوهمية* ل مواقع السوشيال ميديا مثل *التيليجرام والواتساب والتويتر وغيره* 👾
...
*- في بوت الإمبراطور 🥇Emperor * ؛ البوت الأفضل على التليجرام والذي يقوم بتوفير *خدمات الأرقام الوهمية* ل مواقع السوشيال ميديا مثل *التيليجرام والواتساب والتويتر وغيره* 👾
...
if ($data == "Important") {
    bot('EditMessageText', [
        ...
        'message_id' => $message_id,
        'text' => "
*- هام للأعضاء الجُدد في بوت الإمبراطور 🥇Emperor
.*
...
",
        ...
        bot('EditMessageText', [
            ...
            'text' => "
👨‍✈️ *⁞ مرحبا بك* [$first](tg://user?id=$id) ؛
🏛 *⁞ هذه تفاصيل حسابك في بوت. الإمبراطور 🥇Emperor
 * ⬇️
...
*- في بوت الإمبراطور 🥇Emperor
 * ؛ البوت الأفضل على التليجرام والذي يقوم بتوفير *خدمات الأرقام الوهمية* ل مواقع السوشيال ميديا مثل *التيليجرام والواتساب والتويتر وغيره* 👾
...
👨‍💻 فريق دعم MOUSA SMS : *@$useradmin*
",
        'parse_mode' => "MarkDown",
        'disable_web_page_preview' => true,
        'reply_markup' => json_encode([
            'inline_keyboard' => [
                [['text' => '💭 - تواصل بـ فريق دعم MOUSA SMS ↖️', 'url' => "tg://user?id=$sudo"]],
...
",
    ...
    bot('EditMessageText', [
        ...
        'message_id' => $message_id,
        'text' => "
🧑‍✈️ *- أهلا بك عزيزي العميل* في قسم وكلاء البوت الرسميين في بوت *الإمبراطور 🥇Emperor
* ☑️
",
        'parse_mode' => "MarkDown",
        'reply_markup' => ($keyboad),
